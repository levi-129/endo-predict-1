          ...
          <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
            <div className="space-y-4 animate-fade-in">
              ...
              <p className="text-lg text-muted-foreground md:text-xl">
                Early detection leads to better outcomes. Our AI-powered tool helps predict endometriosis risk based on clinical indicators.
              </p>
            ...
            <div className="mx-auto lg:mx-0 animate-fade-in" style={{ animationDelay: "0.2s" }}>
              <div className="glass-card p-1">
                <img
                  src="https://img.freepik.com/free-vector/doctor-nurse-study-discuss-xray-image_81522-4778.jpg"
          ...
          <div className="grid gap-6 lg:grid-cols-2">
            ...
            <div>
              <div className="glass-card p-1 h-full">
                <img
                  src="https://img.freepik.com/free-vector/female-reproductive-system-concept-illustration_114360-17167.jpg"
        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-muted-foreground">
              © 2025 Endo Predict. All rights reserved.
            </p>
